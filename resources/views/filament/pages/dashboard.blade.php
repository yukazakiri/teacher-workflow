                                ...
                                <div class="bg-primary-50 dark:bg-primary-700/20 rounded-lg p-4 border border-primary-200 dark:border-primary-600 ring-2 ring-primary-500/50 dark:ring-primary-500/70 shadow-sm">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-primary-800 dark:text-primary-200/90">Invite students via email or share a join code.</p>
                                        </div>
                                    </div>
                                </div>
                                {{-- Step 2 (Future) --}}
                            ...
                            >
                             ...
                             @if($onboardingState === 1)
                               <x-filament::button
                                   ...
                                   @click="open = false" {{-- Close modal immediately, wire:click happens on link navigation if needed, but better to mark complete on dismiss/outside click --}}
                                   wire:click="markOnboardingStepComplete(1)" {{-- Ensure step marked complete on primary action too --}}
                                   class="w-full sm:w-auto" {{-- Full width on mobile --}}
                             ...
                             @elseif ($onboardingState === 2)
                                <x-filament::button
                                   ...
                                   @click="open = false"
                                   wire:click="markOnboardingStepComplete(2)" {{-- Ensure step marked complete on primary action too --}}
                                   class="w-full sm:w-auto" {{-- Full width on mobile --}}
