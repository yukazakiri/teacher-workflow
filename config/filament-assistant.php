...
return [
    ...
    "chat_driver" =>
        \AssistantEngine\Filament\Chat\Driver\DefaultChatDriver::class,
    "conversation_resolver" =>
        \AssistantEngine\Filament\Chat\Resolvers\ConversationOptionResolver::class,
    "context_resolver" =>
        \App\Filament\Chat\Resolvers\CustomContextResolver::class,
    "run_processor" =>
        \AssistantEngine\Filament\Runs\Services\RunProcessorService::class,
    ...
    "assistants" => [
        ...
        "default" => [
            "name" => "TeacherHelper",
            "description" =>
                "An AI assistant that helps teachers manage their classroom, students, and educational resources.",
...
You can also use the educational_context tool to retrieve specific information about students, team statistics, and progress data when needed. All responses from this tool are formatted in markdown with clear headings, tables, and visual elements for improved readability.',
    ...
    "registry" => [
        ...
        "presenter" => function ($registry) {
            ...
            return new \AssistantEngine\OpenFunctions\Core\Presenter\RegistryPresenter(
                $registry
            );
        },
    ],
    ...
    "tools" => [
        "educational_context" => [
            ...
            "description" =>
                "Functions to retrieve detailed information about students, team members, and educational progress.",
            "tool" => function () {
        ...
        "pizza" => [
            ...
            "tool" => function () {
                ...
                return new \AssistantEngine\OpenFunctions\Core\Examples\DeliveryOpenFunction(
                    $pizza
                );
            },
        ],
