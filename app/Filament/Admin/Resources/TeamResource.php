...
use Illuminate\Support\Collection; // Needed for options callback
use Illuminate\Validation\ValidationException; // For custom validation
                    ...
                    Forms\Components\Select::make("grading_system_type")
                        ...
                        ->options([
                            Team::GRADING_SYSTEM_SHS =>
                                "K-12 Senior High School (Component Weighted)",
                    ...
                    Forms\Components\Fieldset::make("SHS Component Weights")
                        ...
                        ->schema([
                            ...
                            Forms\Components\Placeholder::make(
                                ...
                                ->extraAttributes([
                                    "class" =>
                                        "filament-forms-placeholder-component-html",
                                ...
                                ->options([
                                    ...
                                    "GWA Based Scales" => [
                                        Team::COLLEGE_SCALE_GWA_5_POINT =>
                                            "GWA Based - 5 Point Scale (1.00 highest)",
                                        Team::COLLEGE_SCALE_GWA_4_POINT =>
                                            "GWA Based - 4 Point Scale (4.0 highest)",
                                        Team::COLLEGE_SCALE_GWA_PERCENTAGE =>
                                            "GWA Based - Percentage Scale (100% highest)",
                                    ],
                                    "Term Based Scales" => [
                                        Team::COLLEGE_SCALE_TERM_5_POINT =>
                                            "Term Based (Prelim, Midterm, Final) - 5 Point Scale",
                                        Team::COLLEGE_SCALE_TERM_4_POINT =>
                                            "Term Based (Prelim, Midterm, Final) - 4 Point Scale",
                                        Team::COLLEGE_SCALE_TERM_PERCENTAGE =>
                                            "Term Based (Prelim, Midterm, Final) - Percentage Scale",
                                    ],
                                ])
                                ->required(
                                    fn(Get $get): bool => $get(
